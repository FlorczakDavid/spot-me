...
import co.simplon.spotmebusiness.validation.SpotUpdateUnicity;
...
@SpotUpdateUnicity
public record SpotUpdate(@NotBlank @Size(max = 200) String name, @Size(max = 2000) String description,
